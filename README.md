...
- Shoot with the 360 camera: chest height, tripod, lights on, shop clean,
  step out of view. Export the equirectangular JPG.
- Compress it (aim under 1.5MB), save as **tour.jpg** in the project
  folder, replacing the demo one. Done — tour.html picks it up.
- No camera yet? Leave the demo tour.jpg in, or remove the Virtual Tour
  nav link from all pages.
